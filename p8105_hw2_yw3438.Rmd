...
*After reading and cleaning the data in Mr. Trash Wheel sheet, there are `r dim(mr_trash_wheel)[1]` observations of `r dim(mr_trash_wheel)[2]` variables in the dataset. The variables include "`r names(mr_trash_wheel)`", among which all the numbers in "sports_balls" have been transformed into integers.

*After reading and cleaning the data in 2018 Precipitation, there are `r dim(pcptt_2018)[1]` observations of `r dim(pcptt_2018)[2]` variables in the dataset "pcptt_2018". The variables include "`r names(pcptt_2018)`".
